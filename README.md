...
<p align="center">
  <strong>16 y/o backend developer from Iran</strong> • I love building solid backends, bots, plugins, APIs and real systems that just work.
</p>
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,java,fastapi,mysql,mongodb,redis,docker,git,linux,premiere,photoshop,vscode&perline=7&theme=dark" alt="Skills" />
</p>

- Python is my main tool – Discord bots with discord.py, FastAPI for APIs, async stuff, automation scripts.
- Java for bigger systems – Minecraft plugins (Spigot/Paper).
- Databases – MySQL/SQLite for relational, MongoDB for flexible data, Redis for caching and real-time.
...
- **Discord Bots** – Big bots connected to Minecraft servers, handling real-time stats, databases (Redis/MongoDB/MySQL), events and logic. (Ranked BedWars Bots)
- **Minecraft Plugins** – Java/Spigot plugins with custom mechanics, data saving, optimization and server-side features. 
- **FastAPI Backends** – Pure REST APIs with auth, CRUD, data processing – kinda no frontend attached.
- **Personal Cloud** (cloud.irxngo.ir) – My own self-hosted storage system with backend logic, file handling and databases (kinda a local storage).
...
- Get really good at backend: scalable APIs, clean code, concurrency, basic system design.
- Level up Java and Python for serious apps, servers and games.
- Learn deeper stuff: networking, OS basics, low-level concepts.
